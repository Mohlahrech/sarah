...
class KsGlobalTaxInvoice(models.Model):
    ...
    ks_global_tax_rate = fields.Float(string='Timbre Fiscal (%):', readonly=True,
    ...
    def ks_check_tax_value(self):
        if self.ks_global_tax_rate > 1 or self.ks_global_tax_rate < 0:
            raise ValidationError('Vous ne pouvez pas entrer de valeur en pourcentage supérieure à 1%.')
